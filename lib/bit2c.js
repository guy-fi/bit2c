module.exports = (function() {
   ...
   function bit2cPublicRequest(operation, currency, param, callback) {
      ...
      var url = 'https://bit2c.co.il/Exchanges/' + currency + '/' + operation;
      if (param) {
   ...
   function bit2cPrivateRequest(path, credentials, paramsString, callback, method) {

      var url = 'https://bit2c.co.il/' + path,
         signature;
   ...
   var that = {
      ...
      getBalance: function(credentials, callback) {
         bit2cPrivateRequest('Account/Balance/v2', credentials,
      ...
      sendPayment: function(credentials, payTo, amount, currency, callback) {
       ...
       buyMarket: function(credentials, orderDetails, callback) {

           var paramsString ='';
           paramsString += 'Total=' + orderDetails.Amount + '&';
           paramsString += 'Pair=' + orderDetails.Pair + '&';
           paramsString += 'nonce=' + getUniqueNonce();

           bit2cPrivateRequest('Order/AddOrderMarketPriceBuy ', credentials,
               paramsString,
               callback, "POST");
       },

       sellMarket: function(credentials, orderDetails, callback) {
           ...
           bit2cPrivateRequest('Order/AddOrderMarketPriceSell ', credentials,
               paramsString,
               callback, "POST");
       },

       withdraw: function(credentials, orderDetails, callback) {

           var paramsString ='';
           paramsString += 'Total=' + orderDetails.Amount + '&';
           paramsString += 'Address=' + orderDetails.Address + '&';
           paramsString += 'Coin=' + orderDetails.Coin + '&';
           paramsString += 'subtractFeeAmount=' + orderDetails.subtractFeeAmount + '&';
           paramsString += 'fee=' + orderDetails.fee + '&';
           paramsString += 'nonce=' + getUniqueNonce();

           bit2cPrivateRequest('Order/WithdrawCoin ', credentials,
               paramsString,
               callback, "POST");
       },
